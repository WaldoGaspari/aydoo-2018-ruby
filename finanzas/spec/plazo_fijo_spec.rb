...
describe 'PlazoFijo' do
  ...
  it 'calcular plazo fijo por un monto de 50, plazo 60 dias e interes 10 porciento NO deberia poder calcularlo y deberia lanzar una excepcion' do
    expect { expect { plazoFijo.calcular_ganancia_del_plazo_fijo(20, 10, 100000) }.to raise_error ArgumentError, 'El monto para los plazos fijos debe ser mayor o igual a 100.'}
  end
  ...
  it 'calcular plazo fijo precancelable por un monto de 100000, plazo acordado 90 dias, plazo real 120 e interes 10 porciento NO deberia poder calcularlo y deberia lanzar una excepcion' do
    expect { expect { plazoFijo.calcular_ganancia_de_plazo_fijo_precancelable(90, 120, 10, 100000) }.to raise_error ArgumentError, 'Plazo real incorrecto. Debe ser mayor o igual a 1 y menor o igual al plazo acordado.'}
  end
  ...
  it 'calcular plazo fijo por un monto de 100000, plazo 90 dias e interes 0,25 porciento NO deberia poder calcularlo y deberia lanzar una excepcion' do
    expect { expect { plazoFijo.calcular_ganancia_del_plazo_fijo(90, 0.25, 100000) }.to raise_error ArgumentError, 'El interes debe ser mayor o igual a 1.'}
  end
